...
interface KeypadProps {
  ...
  isFirstCalculatorInput:boolean
  setIsFirstCalculatorInput: (value: boolean) => void
  firstCalculatorInputHasAnswer:boolean,
  setFirstCalculatorInputHasAnswer: (value: boolean) => void
  ...
  notifyMessage: (value: string) => string
 }
...
const Keypad: React.FC<KeypadProps> = ({
  ...
  operator,
  setOperator,
  isFirstCalculatorInput,
  setIsFirstCalculatorInput,
  firstCalculatorInputHasAnswer,
  setFirstCalculatorInputHasAnswer,
  overwriteNumber,
  setOverwriteNumber,
